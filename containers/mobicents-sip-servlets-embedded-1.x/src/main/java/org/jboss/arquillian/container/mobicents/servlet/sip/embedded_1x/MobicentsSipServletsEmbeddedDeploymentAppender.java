 ...
 * @version $Revision: $
 */
public class MobicentsSipServletsEmbeddedDeploymentAppender implements AuxiliaryArchiveAppender
{
   public Archive<?> createAuxiliaryArchive()
   {
      JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "arquillian-mobicents-sip-servlets-testenrichers.jar")
            .addPackages(
                  false,
