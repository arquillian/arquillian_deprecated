...
import org.jboss.arquillian.container.osgi.embedded.bundle.internal.SimpleActivator;
...
public class OSGiEmbeddedFrameworkTestCase
{
   ...
   {
      final JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "osgi-simple-embedded");
